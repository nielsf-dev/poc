...
public class MyHostBuilder : IHostBuilder
{
    ...
    private IMyServiceFactoryAdapter _serviceProviderFactory = new MyServiceFactoryAdapter<IServiceCollection>(new DefaultServiceProviderFactory());
    ...
    {
        _serviceProviderFactory = new MyServiceFactoryAdapter<TContainerBuilder>(factory ?? throw new ArgumentNullException(nameof(factory)));
        return this;
    }
    ...
    {
        _serviceProviderFactory = new MyServiceFactoryAdapter<TContainerBuilder>(() => _hostBuilderContext, factory ?? throw new ArgumentNullException(nameof(factory)));
        return this;
    }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        services.AddSingleton<IHost>(_ =>
        {
            ...
            return new MyHost(_appServices,
                _hostingEnvironment,
                _defaultProvider,
                _appServices.GetRequiredService<IHostApplicationLifetime>(),
                _appServices.GetRequiredService<ILogger<MyHost>>(),
                _appServices.GetRequiredService<IHostLifetime>(),
                _appServices.GetRequiredService<IOptions<HostOptions>>());
        });

        // gemakshalve ff uitgezet
         services.AddOptions().Configure<HostOptions>(options => { Initialize(options, _hostConfiguration); });
